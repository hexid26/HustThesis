\chapter{Multi-pathRouting for Energy Efﬁcient Mobile Ofﬂoading in Software Deﬁned Networks}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=360pt, height=180pt]{./figures/ISPA/OffloadingSDN.eps}
  \vspace{-1em}
...
\begin{figure}[!h]
  \vspace{-2em}
  \centering
  \includegraphics[width=280pt]{./figures/ISPA/scenario}
  \vspace{-1em}
...
\begin{figure}[!h]
  \centering
  \vspace{-1em}
  \includegraphics[width=300pt]{./figures/ISPA/Delay}
  \vspace{-1em}
...
\begin{figure}[!h]
  ...
  \begin{subfigure}[b]{0.45\linewidth}
    \includegraphics[width=180pt]{./figures/ISPA/NetworkX_spring_L}
    \label{fig_smallNetworkL}
    \caption{Weight of latency (s)}
  \end{subfigure} %
  \begin{subfigure}[b]{0.45\linewidth}    
    \includegraphics[width=180pt]{./figures/ISPA/NetworkX_spring_B}
...
\begin{figure}[!h]
\centering
\includegraphics[width=200pt]{./figures/ISPA/small_E}
\vspace{-1em}
\caption{The total energy consumption via different methods}
\vspace{-0.5em}
\label{fig_smallE}
...
\begin{figure}[!h]
\centering
\includegraphics[width=200pt]{./figures/ISPA/small_Au}
\vspace{-1em}
...
\begin{figure}[!h]
  ...
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=160pt]{./figures/ISPA/small_rule_grb.pdf}
    \label{fig_smallNetworkRG}
    \caption{Rule usage via Gurobi}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=160pt]{./figures/ISPA/small_rule_lsw.pdf}
    \label{fig_smallNetworkRL}
    \caption{Rule usage via LSW}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=160pt]{./figures/ISPA/small_rule_spf.pdf}
...
\begin{figure}[!h]
  \centering
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=160pt]{./figures/ISPA/large_E}
    \label{fig_largeE}
    \caption{能量总开销}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=160pt]{./figures/ISPA/large_Au}
    \label{fig_largeAu}
    \caption{平均任务卸载率}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=160pt]{./figures/ISPA/large_link}
    \label{fig_largeL}
    \caption{网络中链路使用数量}
  \end{subfigure}
