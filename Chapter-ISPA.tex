\chapter{考虑流表容量的能耗最小化感知数据计算卸载调度}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=250pt]{./figures/Sec_ISPA/large_Au}
  % \vspace{-1em}
  \vspace{-0.5em}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=250pt]{./figures/Sec_ISPA/large_E}
  % \vspace{-1em}
  \vspace{-0.5em}
...
\red{
由于 MM 调度算法的宗旨就是追求网络中的链路数量最小，因此在该测试中，MM 调度算法的链路使用总数都相对最小。
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=250pt]{./figures/Sec_ISPA/large_link}
  % \vspace{-1em}
  \vspace{-0.5em}
