...
\begin{figure}[!h]
  ...
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=160pt]{./figures/Sec_ISPA/small_rule_grb.pdf}
    \label{fig_smallNetworkRG}
    \caption{Rule usage via Gurobi}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=160pt]{./figures/Sec_ISPA/small_rule_lsw.pdf}
    \label{fig_smallNetworkRL}
    \caption{Rule usage via LSW}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=160pt]{./figures/Sec_ISPA/small_rule_spf.pdf}
